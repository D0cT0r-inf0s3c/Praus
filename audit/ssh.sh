...
echo
echo  "\e[1;95m-------------------------[ssh audit in progress]-------------------------"
...
sleep 2
echo  "\e[39m[*] Checking /etc/ssh/sshd_config owner\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/ssh/sshd_config group\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/ssh/sshd_config file permissions\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if port has been changed\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Protocol 2 is enabled\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if LogLevel is set to INFO\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if MaxAuthTries has been configured\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if IgnoreRhosts is enabled\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if HostbasedAuthentication is disabled\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if root login is enabled\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Empty Passwords are disabled\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if users are allowed to set environment options\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if only approved ciphers are allowed\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if MAC has been configured\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if ClientAliveInterval has been configured\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if ClientAliveCountMax has been configured\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Banner has been configured\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/issue.net text content\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if only wheel group is allowed to access ssh\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if X11 forwarding is disabled\t\t\t\t\t\t$status"
