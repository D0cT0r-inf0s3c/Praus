...
sleep 2
echo  "\e[39m[*] Checking if IP forwarding is disabled\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if IP forwarding is disabled for active kernel\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if packet redirect is disabled (all)\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if packet redirect is disabled (default)\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if packet redirect is disabled for active kernel (all)\t\t\t$status"
...
echo  "\e[39m[*] Checking if packet redirect is disabled for active kernel (default)\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if source routed packets is disabled (all)\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if source routed packets is disabled (default)\t\t\t\t$status"
...
sleep 2
echo "\e[39m[*] Checking if source routed packets are disabled for active kernel (all)\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if source routed packets are disabled for active kernel (default)\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if ICMP redirects are disabled (all)\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if ICMP redirects are disabled (default)\t\t\t\t\t$status"
...
sleep 2
echo "\e[39m[*] Checking if ICMP redirects are disabled for active kernel (all)\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if ICMP redirects are disabled for active kernel (default)\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if suspicious packets logging is enabled (all)\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if suspicious packets logging is enabled (default)\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if suspicious packets logging is enabled for active kernel (all)\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if suspicious packets logging is enabled for active kernel (default)\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if broadcast ICMP requests are ignored\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if broadcast ICMP requests are ignored for active kernel\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Bad Error Message Protection is enabled\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Bad Error Message Protection is enabled for active kernel\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Source Route Validation is enabled (all)\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Source Route Validation is enabled (default)\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Source Route Validation is enabled for active kernel (all)\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if Source Route Validation is enabled for active kernel (default)\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if TCP SYN Cookies is enabled\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if TCP SYN Cookies is enabled for active kernel\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking TCP Wrappers installation\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/hosts.allow owner\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/hosts.allow group\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/hosts.allow file permissions\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/hosts.deny owner\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking /etc/hosts.deny group\t\t\t\t\t\t\t$status"
...
sleep 2
echo "\e[39m[*] Checking /etc/hosts.deny file permissions\t\t\t\t\t\t$status"
