...
sleep 2
echo  "\e[39m[*] Checking iptables installation\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking iptables-persistent installation\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if netfilter-persistent service is enabled\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if null packets are blocked\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if syn-flood attacks are blocked\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if XMAS packets are blocked\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if internal traffic on the loopback device is allowed\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if ssh access is allowed\t\t\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if established connections are allowed\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if outgoing connections are allowed\t\t\t\t\t$status"
...
sleep 2
echo  "\e[39m[*] Checking if default firewall policy is deny\t\t\t\t\t\t$status"
